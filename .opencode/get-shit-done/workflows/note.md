...
- **Global scope**: `/Users/bonanugroho/projects/vibing/harmoni/harmoni-app/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/bonanugroho/projects/vibing/harmoni/harmoni-app/.opencode/notes/`)
...
2. Glob `/Users/bonanugroho/projects/vibing/harmoni/harmoni-app/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/bonanugroho/projects/vibing/harmoni/harmoni-app/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/bonanugroho/projects/vibing/harmoni/harmoni-app/.opencode/notes/` — works in any directory
