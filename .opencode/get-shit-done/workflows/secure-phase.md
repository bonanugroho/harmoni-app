...
```
Agent(
  prompt="Read /Users/bonanugroho/projects/vibing/harmoni/harmoni-app/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/bonanugroho/projects/vibing/harmoni/harmoni-app/.opencode/get-shit-done/templates/SECURITY.md`
