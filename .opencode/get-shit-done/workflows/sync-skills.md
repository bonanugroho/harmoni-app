...
INSTALL_JS_GLOBAL="/Users/bonanugroho/projects/vibing/harmoni/harmoni-app/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/bonanugroho/projects/vibing/harmoni/harmoni-app/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
