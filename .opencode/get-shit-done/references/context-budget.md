...
The keys live in `.claude/settings.json` (project) or `/Users/bonanugroho/projects/vibing/harmoni/harmoni-app/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
